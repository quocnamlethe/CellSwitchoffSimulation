...
%          nearest neighbour distance
    ...
    numSOn = nPoints - round(nPoints * percentSO);
    ...
    BaseStation.InactiveBs = [BaseStation.InactiveBs; offBS];
